...
const homeData={
  ...
  description: 'Leverage on any tokens with a protocol trusted with billions'+
...
const homeData2={
  ...
  description: 'You can send and receive any crypto on '+
...
const homeData3={
  ...
  description: 'We have all been in this industry too long not to make the security of your '+
